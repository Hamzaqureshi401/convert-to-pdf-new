              ...
              <div class="row">
                <div class="col-md-12 mb-3">
                  <div class="artisan-uploader bg-light rounded uploader-file-uploader">
                    <input id="file-uploader" type="file" name="wordFile" accept=".csv,.ex">
                    ...
                    <label for="file-uploader" class="file-drag">
                      <div class="uploader-wrapper">
                        ...
                        <div class="uploader-extensions mb-3">
                          <span class="badge text-uppercase" style="color:#333">.ex</span>
                          <span class="badge text-uppercase" style="color:#333">.csv</span>
                        </div>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u876012718/domains/editevolv.com/public_html/editepdf/resources/views/frontend/pdftool/pdftoexcel.blade.php ENDPATH**/ ?>