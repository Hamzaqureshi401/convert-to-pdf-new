        ...
        <div class="row">
            <div class="col-md-12">
                <div class="wrap-content">
                    ...
                    <form id="convertForm" action="<?php echo e(route('pdf.to.word')); ?>" method="POST" enctype="multipart/form-data">
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\convert to pdf\resources\views/frontend/pdftool/pdftoword.blade.php ENDPATH**/ ?>