  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo e(route('dashboard')); ?>" class="logo d-flex align-items-center">
        <img src="backend/img/logo2.png" alt="Edite volv">
        <span class="d-none d-lg-block">Edite volv</span>
      </a>
...
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('logout')),'onclick' => 'event.preventDefault();
                      ...
                      <i class="bi bi-box-arrow-right"></i> <?php echo e(__('Log Out')); ?>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="wallet">
          <i class="bi bi-gem"></i><span>Wallet</span>
        </a>
      </li>
...
<?php /**PATH C:\xampp\htdocs\convert to pdf\convert-to-pdf\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>