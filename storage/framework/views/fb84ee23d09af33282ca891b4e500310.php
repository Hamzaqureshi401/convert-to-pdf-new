                    ...
                    <label for="file-uploader" class="file-drag">
                      <div class="uploader-wrapper">
                        ...
                        <div class="uploader-extensions mb-3">
                          <span class="badge text-uppercase" style="color:#333">.ppt</span>
                          <!--<span class="badge text-uppercase" style="color:#333">.docx</span>-->
                        </div>
                        <p>Make "All" files easy to read by converting them to PPT.</p>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u876012718/domains/editevolv.com/public_html/editepdf/resources/views/frontend/pdftool/powerpointtopdf.blade.php ENDPATH**/ ?>