    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="loginForm" action="<?php echo e(route('login2')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                   <div class="mb-3">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function handleBalanceCheckAndConfirm() {
            $.ajax({
                url: "<?php echo e(route('checkBalance')); ?>",
                method: 'GET',
                headers: {
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#addBalance').off('click').on('click', function() {
                            ...
                            window.location.href = "<?php echo e(route('addBalancePage')); ?>"; // Replace with actual route
                        });
...
<?php /**PATH C:\xampp\htdocs\convert to pdf\resources\views/components/LoginComponent.blade.php ENDPATH**/ ?>