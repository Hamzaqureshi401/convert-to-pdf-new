		...
		<div class="container ">
			<div class="row">
				...
				<div class="col-md-6 upoladpdf">
					<div class="pdf-icon">
						<!-- <img class="img-main" src="<?php echo e(asset('frontend/img/main-img/main-picture.png')); ?>" alt="PDF Icon" /> -->
						<img class="icon img-excel" src="<?php echo e(asset('frontend/img/main-img/intro-animation-excel.png')); ?>"
							alt="PDF Icon" />
						<img class="icon img-img" src="<?php echo e(asset('frontend/img/main-img/intro-animation-image.png')); ?>" alt="PDF Icon" />
						<img class="icons img-ppt" src="<?php echo e(asset('frontend/img/main-img/intro-animation-ppt.png')); ?>" alt="PDF Icon" />
						<img class="icons img-word" src="<?php echo e(asset('frontend/img/main-img/intro-animation-word.png')); ?>" alt="PDF Icon" />
						<!--<?php echo e(asset('css/bootstrap.min.css')); ?>-->
					</div>
					...
					<div class="integration-icons">
						<img src="<?php echo e(asset('frontend/img/main-img/box-logo.svg')); ?>" alt="Box Icon" />
						<img src="<?php echo e(asset('frontend/img/main-img/gdrive-logo.svg')); ?>" alt="Google Drive Icon" />
						<img src="<?php echo e(asset('frontend/img/main-img/dropbox-logo.svg')); ?>" alt="Dropbox Icon" />
						<img src="<?php echo e(asset('frontend/img/main-img/link-logo.svg')); ?>" alt="Link Icon" />
					</div>
				</div>
			</div>
		</div>
	...
	<div class="premium">
		<section class="premium-sec">
			<div class="prem contain">
				...
				<div class="pre-column">
					<img src="<?php echo e(asset('frontend/img/main-img/hero.png')); ?>" alt="heroImg" class="pre_img" />
				</div>
			</div>
			<img src="<?php echo e(asset('frontend/img/main-img/bg-bottom-hero.png')); ?>" alt="" class="curveImg" />
		</section>
	</div>
	...
	<section class="faq-area white-bg ptb-100" style="background: #e2e2e2;">
		<div class="container-fluid">
			<div class="row align-items-center">
				...
				<div class="col-lg-6">
					<div class="faq-img">
						<img src="<?php echo e(asset('frontend/img/main-img/faq-img.png')); ?>" alt="Image">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="shape faq-shape-1">
			<img src="<?php echo e(asset('frontend/img/main-img/faq-shape-1.png')); ?>" alt="Image">
		</div>
		<div class="shape faq-shape-2">
			<img src="<?php echo e(asset('frontend/img/main-img/faq-shape-2.png')); ?>" alt="Image">
		</div>
	</section>
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u876012718/domains/editevolv.com/public_html/editepdf/resources/views/frontend/index.blade.php ENDPATH**/ ?>